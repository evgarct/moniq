...
export type SyncCommand =
  ...
  | SyncCommandBase<"schedule.updateNote", { note: string | null; fromOccurrenceDate: string }>
  | SyncCommandBase<"schedule.updateFromOccurrence", { fromOccurrenceDate: string; changes: Record<string, unknown> }>
