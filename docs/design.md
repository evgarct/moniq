...
- Savings subgroups: not nested cards; no filled hover/selected background; progress track starts on the same vertical axis as the subgroup label — the canonical thin-track reference for other inventory extensions.
