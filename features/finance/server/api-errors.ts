const FINANCE_ERROR_KEYS = {
  ...
  "Only transfers into a savings goal can use a category.": "common.errors.transaction.transferNoCategory",
  "Savings transfers can only use an expense category.": "common.errors.transaction.transferCategoryExpenseOnly",
