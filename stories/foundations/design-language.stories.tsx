      ...
      <div className="flex h-full flex-col gap-6 p-6">
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_360px]">
          ...
          <Surface tone="floating" padding="lg" className="flex flex-col gap-5">
            ...
            <Surface tone="canvas" padding="md" className="border border-black/8 bg-[#f7f3ef]">
        ...
        <Surface tone="canvas" padding="md" className="min-h-0 flex-1 overflow-hidden border border-black/8 bg-[#f7f3ef] shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
          <AccountsView
